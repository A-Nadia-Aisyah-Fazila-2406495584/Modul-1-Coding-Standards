...
class PayOrderSuccessFunctionalTest {
    ...
    @Test
    void payOrderSuccessPage_title_isCorrect(ChromeDriver driver) {
    ...
    @Test
    void payOrderSuccessPage_hasCheckPaymentLink(ChromeDriver driver) {
