...
class OrderHistoryFunctionalTest {
    ...
    @Test
    void orderHistoryPage_title_isCorrect(ChromeDriver driver) {
        driver.get(baseUrl + "/order/history");
        assertEquals("Order History", driver.getTitle());
    }

    @Test
    void orderHistoryPage_header_isCorrect(ChromeDriver driver) {
        driver.get(baseUrl + "/order/history");
        assertEquals("Order History", driver.findElement(By.tagName("h1")).getText());
    }

    @Test
    void orderHistoryPost_withAuthor_staysOnHistoryPage(ChromeDriver driver) {
        driver.get(baseUrl + "/order/history");
